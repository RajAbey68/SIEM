...
export default function ContactUs() {
	return (
		...
		>
			...
			>
				We welcome enquiries for all types of construction projects. Please use
				the contact form on the right, or reach us directly using the details
				below.
			</p>
			<div
				style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "2rem" }}
				className="contact-detail-grid"
			>
				<div>
					<h3
						style={{
					...
					>
						{[
							...
							<tr key={day} style={{ borderBottom: "1px solid #f0f0f0" }}>
								...
								<td style={{ padding: "0.6rem 0", color: "var(--brand-teal)" }}>
									{hours}
								</td>
							</tr>
						))}
