...
export default function Navbar() {
	...
	return (
		<header style={{ background: "#fff", borderBottom: "1px solid #ddd" }}>
			{/* ── Logo row: actual logo.jpg from siem-construction.vercel.app ───────────────── */}
			<div
			...
			>
				...
				>
					{navLinks.map((link) =>
						link.children ? (
							// biome-ignore lint/a11y/noStaticElementInteractions: Dropdown container needs hover state
							<div
								key={link.href}
							...
							>
								<Link
									...
									style={{
										...
										color: isActive(link.href) ? "var(--brand-navy)" : "#333",
										textDecoration: "none",
						...
						<div key={link.href}>
							...
							{link.children?.map((c) => (
								<Link
									...
									style={{
										display: "block",
										padding: "10px calc(var(--section-px) + 1rem)",
										fontFamily: "var(--font-ui)",
										fontSize: "0.82rem",
										color: "#666",
										textDecoration: "none",
